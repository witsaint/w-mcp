...
const createDocsTemplateTool = packTool({
  description: "After doc_gen_begin\uFF0CAn Step for gen doc\u3002Create a Nextra documentation site template at the specified location, targetPath is the .doc folder, eg: /your/project/.doc",
